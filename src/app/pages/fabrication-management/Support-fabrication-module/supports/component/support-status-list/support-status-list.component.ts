...
import { SupportStatusFormComponent } from '../support-status-form/support-status-form.component';

@Component({
  selector: 'app-support-status-list',
  templateUrl: './support-status-list.component.html',
  styleUrls: ['./support-status-list.component.scss']
})
export class SupportStatusListComponent implements OnInit {
  ...
  async initTableParam() {
    ...
    param.api = ApiURL.support_statuses 
    param.defaultFilter = new Map<any,any>([['supportHeadersId',this.parentHeader.id]])
    param.dataKey = 'id'
